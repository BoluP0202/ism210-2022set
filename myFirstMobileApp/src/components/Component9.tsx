...
import { View, Text, TextInput, Button, TouchableWithoutFeedback, Platform, Switch, Slider, Alert } from 'react-native';
...
const Component9: React.FC = () => {
 ...
 setState({...state, museumItem:{...state.museumItem, dateCommissioned: dateCommissioned}, showDatePicker:
Platform.OS === 'ios' ? true : false})//no need to hide if Platform is iOS
 }
 ...
 <DateTimePicker value={state.museumItem.dateCommissioned !== undefined? state.museumItem.dateCommissioned: new
Date()}
 mode={'date'}
 is24Hour={true}
 display="default"
